...
//    final int[] arr = new int[] {39,12,46,42,19,32,68,58,11,11,33,70,47,40,79,37,50,60,67,37,64,66,91,41,62,87,88,71,8,22,74,27,27,90,41,24,50,53,92,42,33,52,74,90,7,58,32,20,25,85,5,53,34,29,75,61,74,1,0,14,99,42,18,57,38,80,54,2,48,28,76,27,95,7,36,36,48,87,53,4,0,86,76,41,20,90,40,88,22,29,62,9,48,22,19,11,30,30,97,82};
    final int[] arr = generateArray();
    final int len = 100000;

    private int[] generateArray(){
        int[] arr = new int[len];
        for (int i = 0; i < len; i++) {
            arr[i] = RandomUtil.getIntegerBetween(0, len);
        }
        return arr;
    }
    ...
    public void testBubble(){
        ...
        int[] result = Sort.sort(arr ,null ,"bubble");
        stopwatch.stop();
...
//        System.out.println(JSONObject.toJSON(result));
    ...
    public void testSimple(){
        Stopwatch stopwatch = Stopwatch.createStarted();
        int[] result = Sort.sort(arr ,null ,"simple");
        stopwatch.stop();
...
//        System.out.println(JSONObject.toJSON(result));
    ...
    public void testInsert(){
        Stopwatch stopwatch = Stopwatch.createStarted();
        int[] result = Sort.sort(arr ,null ,"insert");
        stopwatch.stop();
...
//    @Test
    public void testShell(){
        Stopwatch stopwatch = Stopwatch.createStarted();
        int[] result = Sort.sort(arr ,null ,"shell");
        stopwatch.stop();
...
//        System.out.println(JSONObject.toJSON(result));
    ...
    public void testQuick(){
        Stopwatch stopwatch = Stopwatch.createStarted();
        int[] result = Sort.sort(arr ,null ,"quick");
        stopwatch.stop();
